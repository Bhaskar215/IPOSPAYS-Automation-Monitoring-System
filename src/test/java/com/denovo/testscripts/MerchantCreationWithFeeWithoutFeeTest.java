...
public class MerchantCreationWithFeeWithoutFeeTest extends BaseTest {
    LoginPage loginPage= new LoginPage();
    MerchantCreationPage merchantCreationPage= new MerchantCreationPage();


    @Test(priority = 1,dataProvider = "getData")
    public void validateMerchantCreationWithoutFee(Map<String,String>data) throws InterruptedException {
