...
public class MerchantCreation_IsoLogin_PrimaryUser_WithoutFeeProfile extends BaseTest {
   LoginPage loginPage= new LoginPage();
    MerchantCreationPage merchantCreationPage= new MerchantCreationPage();


    @Test(priority = 1,dataProvider = "getData")
    public void merchantCreation_IsoLogin_PrimaryUser_WithoutFeeProfile(Map<String,String> data) throws InterruptedException {
    ...
    public  Object[][] getData() throws IOException {
        ...
        arrObject= DataProviderUtil.getExcelData(System.getProperty("user.dir")+"/src/main/java/com/denovo/ExcelData/SE_DataSheet.xlsx",
                "ISO(Primary)MerchantWithoutFee");
        return arrObject;
    }
