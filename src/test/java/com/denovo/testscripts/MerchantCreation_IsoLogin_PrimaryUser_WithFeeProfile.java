...
public class MerchantCreation_IsoLogin_PrimaryUser_WithFeeProfile extends BaseTest {
    LoginPage loginPage= new LoginPage();
    MerchantCreationPage merchantCreationPage= new MerchantCreationPage();


    @Test(priority = 1,dataProvider ="getData")
    public void merchantCreation_IsoLogin_PrimaryUser_WithFeeProfile(Map<String,String> data) throws InterruptedException {
