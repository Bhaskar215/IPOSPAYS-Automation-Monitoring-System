...
public class MerchantCreation_AgentLogin_PrimaryUser_WithFee extends BaseTest {
    LoginPage loginPage= new LoginPage();
    MerchantCreationPage merchantCreationPage= new MerchantCreationPage();

    @Test(priority = 1,dataProvider = "getData")
    public void merchantCreation_AgentLogin_PrimaryUser_WithFee(Map<String,String> data) throws InterruptedException {
